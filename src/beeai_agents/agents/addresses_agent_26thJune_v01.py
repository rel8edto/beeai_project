...
async def key_addresses(
    ...
    try:
        ...
        system_guard = (
            "You are writing a **Key Addresses** paragraph for an analyst report.\n"
            "• Begin with the bold heading **Key Addresses – {name}**.\n"       
            "• Base every sentence only on the addresses I give you.\n"
            "• Include the company’s name in the first sentence.\n"               
            "• DO NOT copy wording from the sample – it is illustrative only.\n"
            "• Do not invent building details or extra commentary.\n"
        ).format(name=name)         
        ...
        prompt = (
                    ...
                    "### Sample (format ONLY):\n"
                    f"{example}\n\n"
                    "### Write the paragraph for the following company.\n"
                    f"• Headquarters: {hq}\n"
